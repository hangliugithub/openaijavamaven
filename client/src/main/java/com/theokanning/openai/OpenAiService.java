...
import com.theokanning.openai.ImageGenerations.ImageGenerationsResult;
...
public class OpenAiService {
    ...
    public ImageGenerationsResult createImagesGenerations(ImageGenerationsRequest request) {
        return api.createImagesGenerations(request).blockingGet();
    }
